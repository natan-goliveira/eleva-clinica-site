...
function DashboardContent() {
  return (
    <div className="flex flex-1 flex-col gap-2.5 p-3 pt-0 overflow-hidden">
      ...
      <div className="grid grid-cols-[1fr_200px] gap-2.5 flex-1 min-h-0">
        {/* Revenue Chart */}
            ...
            <div className="flex-1 min-h-0">
              <ChartContainer config={revenueConfig} className="h-full w-full">
                <BarChart data={revenueData} barGap={2}>
                  ...
                  <Bar dataKey="meta" fill="var(--color-meta)" radius={[3, 3, 0, 0]} barSize={16} />
                  <Bar dataKey="receita" fill="var(--color-receita)" radius={[3, 3, 0, 0]} barSize={16} />
                </BarChart>
              </ChartContainer>
            </div>
          </CardContent>
...
filepath = "/Users/natanoliveira/Desktop/73cod/site73/src/components/sections/SistemaSection.tsx"
with open(filepath, 'w', encoding='utf-8') as f:
    f.write(content)
print(f"Wrote SistemaSection.tsx ({len(content)} chars)")
